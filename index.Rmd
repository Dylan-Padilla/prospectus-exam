...
# Chapter: The evolution of foraging-mode polymorphism in *Drosophila melanogaster*

## Introduction
	<p align="justify">
	Despite advances on the mechanistic basis of rover/sitter differences, the evolutionary significance and maintenance of the polymorphism are yet to be investigated in depth. Some evidence suggest that density-dependent selection during the larval stage of *Drosophila*, rather than the adult stage of development, is sufficient to maintain variation in rover and sitter behavior in laboratory populations. For instance, a high larval density favors rovers and low larval density favors sitters [@sokolowski1997evolution]. In the case of negative frequency-dependent selection, the frequency of one morph increases when it is rare relative to the other morph [@fitzpatrick2007maintaining]. However, little is known about how the frequency of the *for* alleles varies in the wild, especially during the adult stage of the fruit fly.
	</p>
	<p align="justify">
	The study of the mechanisms that influence genetic variation over space and time in natural populations is fundamental to understand the process of evolution. Often, species distributed over broad geographic ranges exhibit spatial or temporal clines in certain traits. *D. melanogaster* is a species with a cosmopolitan geographic range that includes all continents and several islands. Good evidence indicates that *D. melanogaster* evolved Bergmann’s clines on more than one continent (Figure \@ref(fig:fig12)). When raised in a common environment, both South American and Australian flies from high latitudes developed faster and matured at larger sizes than their counterparts from low latitudes [@james1997genetic]. Similarly, seasonal stresses at high latitudes, such as overwinter survival and ephemeral food resources, impose strong selection for increased body size and somatic maintenance, whereas warm climates with ample feeding opportunities favor reduced size and decreased maintenance [@paaby2009dissecting; @james1997genetic]. Because the foraging behavior of organisms influences their ability to gather and assimilate food to reach an optimal body size, I expect the frequency of genotypes able to efficiently forage (rover) to increase with latitude and over stressful time (e.g. winter) relative to the frequency of genotypes that are less efficient at foraging (sitter). Yet, under favorable conditions such as in the tropic (or during summer), I expect the frequency of both genotypes to be the same.
	</p>
	<p align="justify">
	With the development of population genomics, we can now analyze patterns of genome-wide genetic variation for large numbers of individuals, with samples structured across space and time (Figure \@ref(fig:fig13)). Accordingly, we have the opportunity to provide new insights into the evolutionary dynamics of the *for* alleles in natural populations. The goal of this chapter is to determine whether the frequency of the *for* alleles vary over space and time as discussed earlier. To do this, we will use published genomes of adult flies collected in the wild. Because several populations of *D. melanogaster* have been sampled worldwide, and at least twice per site of collection (during summer and fall), not only can we test whether the allele frequencies change geographically, but also in response to seasonality.
	</p>
